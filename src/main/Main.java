...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        NGramMap nGram = new NGramMap(WORD_HISTORY_SIZE14377_FILE, YEAR_HISTORY_FILE);
        hns.startUp();
        hns.register("hyponyms", new HyponymsHandler(SYNSETS_SIZE16_FILE, HYPONYMS_SIZE16_FILE, nGram));
